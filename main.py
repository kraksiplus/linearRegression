...
from helpers import (convert_to_float, export_dataframe, data_analysis, plot_variances,
                     proportion_nan, count_three_decimals_values, test_algorythm_accuracy)
...
test_algorythm_accuracy(df_imputed_scaled_back, nan_percentage=count_three_decimals_values(df_imputed_scaled_back))
